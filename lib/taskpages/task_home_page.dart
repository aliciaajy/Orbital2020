...
class _MyHomePageState extends State<MyHomePage> {
        ...
        onPressed: () {
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text(currentPage == 0 ? "Add New Task" : "Add New Event",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                content: new Column(
                  ...
                  children: <Widget> [
                    ...
                    TextField(
                      controller: mycontroller,
                       decoration: InputDecoration(hintText: currentPage == 0 ? 'Enter task': "Enter event"),
                      onChanged: (String value) {
                        input = currentPage == 0?(tasklist.length+1).toString() + ". " + value : value;
                      }
                    ),
                ...
                actions: <Widget>[
                  FlatButton(
                    onPressed: () {
                      setState( () {
                        currentPage == 0 ? tasklist.add(TaskList(input)): eventlist.add(EventList(input, _selectedTime)) ;
      ...
      children: <Widget>[
        ...
        Expanded(
          child: PageView(
            ...
            children: <Widget>[taskbodycontent(context),eventbodycontent(context)],
          ))
        ],
      );
  }
  ...
  Container _lineStyle(BuildContext context, double iconSize, int index, int listLength, bool done) {
    return Container(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: Row(
            children: <Widget>[
                _lineStyle(context, iconSize, index, eventlist.length,eventlist[index].done),
